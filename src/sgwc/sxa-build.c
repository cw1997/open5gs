...
static int num_of_remove_pdr;
static int num_of_remove_far;
static int num_of_create_pdr;
static int num_of_create_far;
static int num_of_update_far;

static void build_modification_request(
        ogs_pfcp_message_t *pfcp_message,
        sgwc_bearer_t *bearer, ogs_pfcp_xact_t *xact)
{
        ...
        uint8_t type, sgwc_sess_t *sess, ogs_pfcp_xact_t *xact)
{
    ...
    ogs_list_for_each(&sess->bearer_list, bearer) {
        build_modification_request(&pfcp_message, bearer, xact);
    }
